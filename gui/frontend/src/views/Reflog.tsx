  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        ...
        <button onClick={load} disabled={!!busy} className={cls.btnSm}>
          {busy === "reflog-load" ? "…" : "Refresh"}
        </button>
      </div>
      <div className="text-xs text-muted-foreground">
        Everywhere HEAD has been. "Reset to here" moves HEAD back to that point — soft keeps your
        changes staged, mixed keeps them unstaged, hard discards them (recoverable from this very
        log).
      </div>
